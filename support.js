...
// const visibile = document.getElementById("content");
...
//   if(key == 32)
//   {
//     let st = window.getComputedStyle(visibile);
//     console.log(st.visibility);   
//     if(String(st) === 'hidden')
//     { 
//       console.log("sd");
//       visibile.removeAttribute('class','h-idden');
//       visibile.setAttribute('class','v-isible');
//     }
//     else { 
//        visibile.removeAttribute('class','v-isible');
//        visibile.setAttribute('class','h-idden');
//     }
